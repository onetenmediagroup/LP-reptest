...
<link rel="stylesheet" href="inc/ddexitpop.min.css">

<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js" crossorigin="anonymous"></script> 

<script src="inc/ddexitpop.min.js"></script>
...
<title>Skull Motorcycle Gloves with breathable fabric</title>
<link rel="stylesheet" href="inc/main.min.css" type="text/css" media="all">
<link rel="stylesheet" href="inc/style.min.css" type="text/css" media="all">
  ...
  <div class="item promo-block lead-image">
    <div class="media">
      <div class="container-lead-image">
        <div class="content">
          <div class="photo"> <a href="#" target="_blank"><img src="inc/img1.png" title="" class="js-srcset-img shortcode-image" alt="" width="100%"></a> <span class="photocredit"></span> </div>
          <!--<img src=""/>-->
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <article id="post-1829462" class="post-1829462 post type-post status-publish format-standard has-post-thumbnail hentry category-celebrity clearfix" role="article">
              <div class="col-md-12 story">
                <div class="header"> <span class="headline">
                  ...
                  <font color="red"></font>
                  Skull Motorcycle Gloves with breathable fabric and water proof exterior</a></h1>
                  </span>
                  <div class="subhead"><font color="red">Lorem ipsum dolor sit amet</font> </div>
                </div>
              ...
              <?php echo date("D F d, Y") ?>
                  ...
                  <center>
                   <a href="#" target="_blank"> <img src="inc/sale.png" width="600"></a>
                  </center>
                  <br>
                  <p> <b>(CL)</b> - Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                  ...
                  </a>  Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                  <p><strong>CL:</strong> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
                  <p><i><strong>Lorem :</strong> Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. about  <a href="#" target="_blank"><strong>Christie Brinkley</strong></a> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                  <a href="#" target="_blank"><strong>looks about
                  20 years younger!</strong></a> quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                  consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                  cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
                  ...
                  <p><i><strong>Lorem :</strong> quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.  <a href="#" target="_blank"><strong><?php echo $offerName; ?></strong></a>,
                  ...
                  <a href="#" target="_blank"><strong><?php echo $offerName; ?></strong></a></i>. Excepteur sint occaecat cupidatat non
                  proident, sunt in culpa qui officia deserunt mollit anim id est laborum.!</p>
            ...
            <!--       <div style="border-width: 3px; width: 100%; padding:20px" class="block-item">
                ...
                document.write(""+dayarray[day]+", "+montharray[month]+" "+daym+", "+year+"") 
                  ...
                  <br>
                  <h3>Special: for a limited time you may be eligible for the full-range of <?php echo $offerName; ?> products. Click the image below no later than <?php echo date("D F d, Y"); ?> to find out!</h3>
                   <div class="picture"> <a href="#" target="_blank"> <img src="inc/sale.png" height="300"></a> </div>
...
<a class="calltoaction cta-url-1" href="#" onclick="ddexitpop.hidepopup()"><img src="<?php echo $popImg; ?>" class="img-fluid"></a>
</div></div>
